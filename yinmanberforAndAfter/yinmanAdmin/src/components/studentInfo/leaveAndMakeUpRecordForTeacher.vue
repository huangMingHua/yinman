...
<script>
    export default{
        props: ["courseTableDetailId","teacherId"],
        data () {
            return {
                tableData: [{
                    date: '2016-05-02',
        ...
        methods:{
            init(){
                this.$http.get('/api/teacher/getleaveAndMakeUpRecord',{params:{id: this.teacherId,courseTableDetailId:this.courseTableDetailId}}).then((response)=>{
