    ...
    <div>
        <div>
            ...
            <el-table
                ...
                <el-table-column
                    prop="courseTableItem.startTime"
                    label="开始时间"
                    width="120"
                    >
                </el-table-column>
                <el-table-column
                    prop="courseTableItem.endTime"
                    label="结束时间"
                    width="120"
                    >
                </el-table-column>
...
<script>
    export default{
        ...
        methods:{
            init(){
                this.$http.get('/api/student/getClassTimeleave',{params:{studentId: this.studentId,courseTableItemId:this.courseTableItemId}}).then((response)=>{
                    let res = response.data;
                    if (res.code) {
                        let {leavesRecord} = res.data;
                        this.courseTableItems = leavesRecord;
                    } else {
