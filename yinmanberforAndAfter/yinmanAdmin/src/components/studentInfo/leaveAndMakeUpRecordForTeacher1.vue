...
<script>
    export default{
        props: ["courseTableItemId","teacherId"],
        data () {
            return {
                tableData: [{
                    date: '2016-05-02',
        ...
        methods:{
            init(){
                this.$http.get('/api/teacher/getleaveAndMakeUpRecord1',{params:{id: this.teacherId,courseTableItemId:this.courseTableItemId}}).then((response)=>{
