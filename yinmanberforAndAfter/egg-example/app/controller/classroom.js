...
module.exports = app => {
    class ClassroomController extends app.Controller { *
        add() {
                ...
                yield this.ctx.service.classroom.delete(id);
            ...
            update() {
                ...
                let result = yield this.ctx.service.classroom.updates(this.ctx.request.body.id, this.ctx.request.body.classroom, this.ctx.request.body.isPiano)
                this.ctx.body = {
                    msg: '修改成功',
                    bool: true,
                };
