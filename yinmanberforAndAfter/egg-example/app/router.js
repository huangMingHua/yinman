...
module.exports = app => {
  ...
  app.get('/signUpCurriculum/getClassById', 'signUpCurriculum.getClassById');
  ...
  app.get('/signUpCurriculum/getSignUpCourseOtherClassTime', 'signUpCurriculum.getSignUpCourseOtherClassTime');
  ...
  app.post('/signUpCurriculum/getByState', 'signUpCurriculum.getByState');
    ...
    // 课时课
  app.post('/classTimeClass/addClassTimeClass', 'classTimeClass.addClassTimeClass');
  ...
  app.get('/student/getCourseTableDetailStudentByTermIdAndStudentId', 'student.getCourseTableDetailStudentByTermIdAndStudentId');
  ...
  app.get('/student/getleaveAndMakeUpRecord', 'student.getleaveAndMakeUpRecord');
  app.get('/student/getleaveAndMakeUpRecord1', 'student.getleaveAndMakeUpRecord1');
  app.get('/student/getCommentList', 'student.getCommentList');
  app.get('/student/getSignUpClassTime', 'student.getSignUpClassTime');
  app.get('/student/getClassTimeleave', 'student.getClassTimeleave');
  app.post('/student/addRenew', 'student.addRenew');
  app.post('/student/getNoReservedQuery', 'student.getNoReservedQuery');
  app.post('/student/addComment', 'student.addComment');
  ...
  app.get('/teacher/getTermClassAndClassTime', 'teacher.getTermClassAndClassTime');
  ...
  app.get('/teacher/getTeamsByTeacherId', 'teacher.getTeamsByTeacherId');
  app.get('/teacher/getleaveAndMakeUpRecord', 'teacher.getleaveAndMakeUpRecord');
  app.get('/teacher/getleaveAndMakeUpRecord1', 'teacher.getleaveAndMakeUpRecord1');
  ...
  app.get('/term/getTermListForCourse', isAdmin, 'term.getTermListForCourse');
  app.post('/term/update', isAdmin, 'term.update');
  app.post('/term/add', isAdmin, 'term.add');
  app.post('/term/delete', isAdmin, 'term.delete');
  app.get('/term/getTeacherList', 'term.getTeacherList');
