  ...
  class Classroom extends app.Service {
    *
        getAll(page, limit) {
                ...
                // }
                // return result;
          const list = yield app.mysql.select('classroom', { where: { isDel: 0 } });
          if (page) {
          ...
          return list;
            ...
            delete(id) {
              const ERR_OK = yield app.mysql.delete('classroom', { id });
    ...
    *
            getByName(name) {
              return yield app.mysql.get('classroom', { name });
            } *
    ...
    *
            update(info) {
              const result = yield app.mysql.update('classroom', info);
              return result;
            }
    }
  return Classroom;
