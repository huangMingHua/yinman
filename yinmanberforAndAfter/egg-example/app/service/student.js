    ...
    class student extends app.Service { *
        findById(id) {
            ...
            add(name, sex, school, parentName, telephone, address, basics, introduceBaby, dateOfBirth, userId,
                ...
                let result = yield app.mysql.insert("student", {
                    name,
                    sex,
                    school,
                    parentName,
            ...
            getById(id) {
                const student = yield app.mysql.get("student", { id: id });
                return student;
            } *
            getByUserId(id) {
            ...
            deleteUser(id) {
                const result = yield app.mysql.delete("student", { id: id })
                return result
            } *
            getNoReserved(page, limit) {
                ...
                var totalCount = yield app.mysql.query("select count(*) from student where booking=0 and sign_up=0")
